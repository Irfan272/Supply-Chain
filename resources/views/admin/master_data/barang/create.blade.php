                            ...
                            <form class=""  enctype="multipart/form-data" action="/admin/barang/store" method="post" novalidate>
                               @csrf
                                ...
                                <div class="field item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input value="{{ old('merk') }}" name="merk" class="@error('merk') parsley-error @enderror form-control" class='optional' data-validate-length-range="5,15" type="text" />
                                        @error('merk')
                                        <ul class="parsley-errors-list filled">
                                            <li class="parsley-required">{{ $message }}</li>
                                        </ul>   
                                ...
                                <div class="field item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input value="{{ old('harga_pokok') }}" name="harga_pokok" class="@error('harga_pokok') parsley-error @enderror form-control" class='optional' data-validate-length-range="5,15" type="number" />
                                        @error('harga_pokok')
                                        <ul class="parsley-errors-list filled">
                                            <li class="parsley-required">{{ $message }}</li>
                                        </ul>   
                                ...
                                <div class="field item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input value="{{ old('harga_jual') }}" name="harga_jual" class="@error('harga_jual') parsley-error @enderror form-control" class='optional' data-validate-length-range="5,15" type="number" />
                                        @error('harga_jual')
                                        <ul class="parsley-errors-list filled">
                                            <li class="parsley-required">{{ $message }}</li>
                                        </ul>   
                                ...
                                <div class="field item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input value="{{ old('foto') }}" name="foto" class="@error('foto') parsley-error @enderror form-control" class='optional' data-validate-length-range="5,15" type="file" />
                                        @error('foto')
                                        <ul class="parsley-errors-list filled">
                                            <li class="parsley-required">{{ $message }}</li>
                                        </ul>   
